defmodule TaskTrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{assignedUser: "some assignedUser", completed: true, desc: "some desc", timeSpent: 42, title: "some title"}
  ...
  describe "update task" do
    ...
    test "redirects when data is valid", %{conn: conn, task: task} do
      ...
      assert html_response(conn, 200) =~ "some updated assignedUser"
    end
